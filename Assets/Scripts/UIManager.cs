...
public class UIManager : MonoBehaviour
{
    ...
    public Button betMenuExitButton;
    ...
    private void WireAllButtons()
    {
        ...
        if (betMenuExitButton != null)
            betMenuExitButton.onClick.AddListener(() => OnBetMenuExitClicked());
    ...
    private void OnBetMenuExitClicked()
    {
        PlayButtonClickSound();
        HideBetMenu();
        StartCoroutine(DelayedHandleReset());
    }
    ...
    private IEnumerator DelayedHandleReset()
    {
        ...
        if (slotController != null)
            slotController.OnBetMenuExited();
    }
    ...
    private IEnumerator WinPopupSequence(int payoutAmount)
    {
        ...
        // Show bet menu after the popup so the player can keep playing
        ShowBetMenu();
    }
    ...
    private IEnumerator PlayCoinRain()
    {
        AudioManager audioManager = AudioManager.Instance;
        if (audioManager != null)
            audioManager.PlayCoinRainSound();
    ...
    private void SpawnCoin(float containerWidth, float containerHeight)
    {
        ...
        // Spawn at a random spot across the top of the screen
